...
var PreloadScene = {
    ...
    start: function() {
        ...
        this.loadImage("item1",			`${IMG_PATH}/item_1.png`);
        this.loadImage("item2",			`${IMG_PATH}/item_2.png`);
        this.loadImage("item3",			`${IMG_PATH}/item_3.png`);
        this.loadImage("item4",			`${IMG_PATH}/item_4.png`);
        this.loadImage("item5",			`${IMG_PATH}/item_5.png`);
        this.loadImage("item6",			`${IMG_PATH}/item_6.png`);
        this.loadImage("item7",			`${IMG_PATH}/item_7.png`);
        this.loadImage("item8",			`${IMG_PATH}/item_8.png`);
        this.loadImage("item9",			`${IMG_PATH}/item_9.png`);
        this.loadImage("item10",		`${IMG_PATH}/item_10.png`);
        this.loadImage("item11",		`${IMG_PATH}/item_11.png`);
        this.loadImage("item12",		`${IMG_PATH}/item_12.png`);
        this.loadImage("item13",		`${IMG_PATH}/item_13.png`);
        this.loadImage("item14",		`${IMG_PATH}/item_14.png`);
        this.loadImage("item15",		`${IMG_PATH}/item_15.png`);
        this.loadImage("throw1",		`${IMG_PATH}/throw_1.png`);
        this.loadImage("throw2",		`${IMG_PATH}/throw_2.png`);
        this.loadImage("throw3",		`${IMG_PATH}/throw_3.png`);
        this.loadImage("throw4",		`${IMG_PATH}/throw_4.png`);
        this.loadImage("throw5",		`${IMG_PATH}/throw_5.png`);
        this.loadImage("throw6",		`${IMG_PATH}/throw_6.png`);
        this.loadImage("throw7",		`${IMG_PATH}/throw_7.png`);
        this.loadImage("throw8",		`${IMG_PATH}/throw_8.png`);
        this.loadImage("throw9",		`${IMG_PATH}/throw_9.png`);
